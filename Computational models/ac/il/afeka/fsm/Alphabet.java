...
public class Alphabet implements Iterable<Character> {
	...
	/**
	 * Creates a new alphabet from the given list of symbols. We assume that the
	 ...
	 * 
	 * <p>
	 * creates a new alphabet object that represents the alphabet {a,b,c} with the
	 * lexicographical order given by a &lt; b &lt; c.
	 * </p>
	 * 
	 ...
	 * 
	 * <p>
	 * That is, the symbols are characters, separated by whitespace. The
	 * lexicographical order of the alphabet follows the order of the list. We
	 * assume that the list does not contain duplicates. For example, the statement
	 * </p>
	 * 
	 * <code>
	 ...
	 * 
	 * <p>
	 * The encoding is identical to the format that <code>Alphabet.parse</code>
	...
	/**
	 * Returns the first string in the lexicographical order of this alphabet (it's
	...
	/**
	 * Given a string from this alphabet, returns the next string in this alphabet's
	 ...
	 * </code>
	 * <p>
	 * returns the string <code>"aca"</code>.
	 * </p>
	 * 
